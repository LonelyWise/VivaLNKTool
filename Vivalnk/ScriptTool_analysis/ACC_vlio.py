            ...
            if len(dt) == 2:
                ...
                if len(time) == 12:
                    if time[2] == time[5] == ":" or time[8] == ".":
                        ...
                        errors.append(
                            "Line {}: Formatting error: Time does not have format HH:MM:SS.mmm.\n".format(num))
                else:
        ...
        if len(keys) > 0:
            ...
            if "magnification" in keys:
                ...
                if isinstance(temp, int):
                    ...
                    errors.append(
                        "Line {}: Data integrity error: Non-integer magnification value encountered.\n".format(num))
            else:
            ...
            if "ecg" in keys:
                ...
                if len(temp) != FS_ECG:
                    if len(temp) < FS_ECG:
                        errors.append(
                            "Line {}: Data integrity error: ECG undersampled ({} / {}).\n".format(num, len(temp),
                                                                                                  FS_ECG))
                    elif len(temp) > FS_ECG:
                        errors.append(
                            "Line {}: Data integrity error: ECG oversampled ({} / {}).\n".format(num, len(temp),
                                                                                                 FS_ECG))
            ...
            if "accAccuracy" in keys:
                ...
                if isinstance(temp, int):
                    ...
                    errors.append(
                        "Line {}: Data integrity error: Non-integer ACC accuracy value encountered.\n".format(num))
            else:
                ...
                for a in xyz:
                    if len(a) == 3:
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer X-axis ACC value encountered.\n".format(
                                    num))
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer Y-axis ACC value encountered.\n".format(
                                    num))
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer Z-axis ACC value encountered.\n".format(
                                    num))
                    else:
                        if len(a) < 3:
                            errors.append(
                                "Line {}: Data integrity error: Fewer than 3 ACC axes encountered.\n".format(num))
                        else:
                            errors.append(
                                "Line {}: Data integrity error: More than 3 ACC axes encountered.\n".format(num))

                if len(xyz) != FS_ACC:
                    if len(xyz) < FS_ACC:
                        errors.append(
                            "Line {}: Data integrity error: ACC undersampled ({} / {}).\n".format(num, len(xyz),
                                                                                                  FS_ACC))
                    elif len(xyz) > FS_ACC:
                        errors.append(
                            "Line {}: Data integrity error: ACC oversampled ({} / {}).\n".format(num, len(xyz), FS_ACC))
            ...
            if "accOffset" in keys:
                ...
                for a in temp:
                    if isinstance(a, int):
                        ...
                        errors.append(
                            "Line {}: Data integrity error: Non-integer accOffset value encountered.\n".format(num))
            ...
            if "recordTime" in keys:
                ...
                if isinstance(temp, int):
                    ...
                    errors.append(
                        "Line {}: Data integrity error: Non-integer record time value encountered.\n".format(num))
            ...
            if "receiveTime" in keys:
                ...
                if isinstance(temp, int):
                    ...
                    errors.append(
                        "Line {}: Data integrity error: Non-integer receive time value encountered.\n".format(num))
        else:
            ...
            if "PPG" in keys:
                ...
                for sample_dict in ppg:
                    ...
                    if "red" in sample_keys:
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer PPG red value encountered.\n".format(num))
                    else:
                    ...
                    if "ir" in sample_keys:
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer PPG IR value encountered.\n".format(num))
                    else:
                    ...
                    if "motion" in sample_keys:
                        ...
                        if isinstance(temp, int):
                            ...
                            errors.append(
                                "Line {}: Data integrity error: Non-integer PPG motion value encountered.\n".format(
                                    num))
                    else:
                ...
                if len(temp_red) != count:
                    if len(temp_red) < count:
                        ...
                        errors.append(
                            "Line {}: Data integrity error: PPG red oversampled ({} / {}).\n".format(num, len(temp_red),
                                                                                                     count))
                ...
                if len(temp_ir) != count:
                    if len(temp_ir) < count:
                        errors.append(
                            "Line {}: Data integrity error: PPG IR undersampled ({} / {}).\n".format(num, len(temp_ir),
                                                                                                     count))
                    elif len(temp_ir) > count:
                        errors.append(
                            "Line {}: Data integrity error: PPG IR oversampled ({} / {}).\n".format(num, len(temp_ir),
                                                                                                    count))
